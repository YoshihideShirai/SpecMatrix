...
1. Django プロジェクト作成
2. Project / User / Requirement / TestCase / TraceLink のモデル作成
3. 管理画面と基本 CRUD
4. カバレッジ計算サービス
5. ダッシュボード
6. Finding / ReviewDecision / AuditLog のモデル作成
7. ルールエンジン
8. AI Review Service の抽象化
9. 仕様書アップロードと要求抽出
10. TestExecution / Evidence の管理
